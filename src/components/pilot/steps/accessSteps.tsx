      ...
      <div className="space-y-4">
        ...
        <div className="mb-6">
          ...
          <ol className="text-sm text-gray-600 ml-4 space-y-3">
            ...
            <li>
              2. Why Root Certificates Matter
              <ul className="ml-4 mt-1 space-y-1">
                <li>• Enables decryption and inspection of network traffic</li>
                <li>• Required for displaying block and warning notifications</li>
                <li>• Ensures secure and transparent internet access</li>
              </ul>
            </li>
